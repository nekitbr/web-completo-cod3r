...
function comparaStr(string1, string2) {
 ...
 console.log(comparaStr('abc','cba'))
 console.log(comparaStr('ac','a'))
 console.log(comparaStr('abc','v'))
 console.log(comparaStr('123','cba'))
