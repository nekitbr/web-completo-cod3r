...
console.log(ehbissexto(100000))
console.log(ehbissexto(4))
console.log(ehbissexto(5))
console.log(ehbissexto(6))
console.log(ehbissexto(7))
console.log(ehbissexto(1988))